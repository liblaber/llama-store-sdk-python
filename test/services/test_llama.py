...
class TestLlama_(unittest.TestCase):
    ...
    def test_get_llama_by_id(self):
        # Mock the API response
        responses.get("http://localhost:8000/llama/8523804993", json={}, status=200)
        # call the method to test
        test_service = Llama("testkey")
        response = test_service.get_llama_by_id(8523804993)
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_get_llama_by_id_required_fields_missing(self):
        # Mock the API response
        responses.get("http://localhost:8000/llama/5116795297", json={}, status=202)
    ...
    def test_get_llama_by_id_error_on_non_200(self):
        # Mock the API response
        responses.get("http://localhost:8000/llama/4548937281", json={}, status=404)
        with self.assertRaises(ClientException):
            test_service = Llama("testkey")
            test_service.get_llama_by_id(4548937281)
        responses.reset()

    @responses.activate
    def test_update_llama(self):
        # Mock the API response
        responses.put("http://localhost:8000/llama/8916328481", json={}, status=200)
        # call the method to test
        test_service = Llama("testkey")
        response = test_service.update_llama({}, 8916328481)
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_update_llama_required_fields_missing(self):
        # Mock the API response
        responses.put("http://localhost:8000/llama/8018861526", json={}, status=202)
        with self.assertRaises(TypeError):
            test_service = Llama("testkey")
    ...
    def test_update_llama_error_on_non_200(self):
        # Mock the API response
        responses.put("http://localhost:8000/llama/2138905233", json={}, status=404)
        with self.assertRaises(ClientException):
            test_service = Llama("testkey")
            test_service.update_llama({}, 2138905233)
        responses.reset()

    @responses.activate
    def test_delete_llama(self):
        # Mock the API response
        responses.delete("http://localhost:8000/llama/4685981350", json={}, status=200)
        # call the method to test
        test_service = Llama("testkey")
        response = test_service.delete_llama(4685981350)
        self.assertEqual(response, {})
        responses.reset(),
    ...
    def test_delete_llama_required_fields_missing(self):
        # Mock the API response
        responses.delete("http://localhost:8000/llama/7763363210", json={}, status=202)
        with self.assertRaises(TypeError):
            test_service = Llama("testkey")
    ...
    def test_delete_llama_error_on_non_200(self):
        # Mock the API response
        responses.delete("http://localhost:8000/llama/1844638195", json={}, status=404)
        with self.assertRaises(ClientException):
            test_service = Llama("testkey")
            test_service.delete_llama(1844638195)
        responses.reset()
