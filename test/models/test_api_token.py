...
class TestApiTokenModel(unittest.TestCase):
    ...
    def test_api_token(self):
        ...
        test_model = ApiToken(access_token="quidem", token_type="corrupti")
        self.assertEqual(test_model.access_token, "quidem")
        self.assertEqual(test_model.token_type, "corrupti")
